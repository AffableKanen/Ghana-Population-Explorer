...
import EconActiveOccupationFilters from "../filters/filters_econ_active_occupation_map";
...
function  EconActiveOccupationMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/econ_active_occupation", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <EconActiveOccupationFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default EconActiveOccupationMap;
