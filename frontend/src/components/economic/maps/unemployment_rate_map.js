...
import UnemploymentRateFilers from "../filters/filters_unemployment_rate_map";
...
function  UnemploymentRateMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/unemployment_rate", {
      method: "POST",
    ...
    const values = data.features.map((f) => f.properties[filters.age_column].toFixed(2));
    ...
    geoJsonLayerRef.current = L.geoJSON(data, {
          ...
          onEachFeature: (feature, layer) => {
            ...
            layer.bindPopup(
              ...
              Percentage: ${feature.properties[filters.age_column].toFixed(2)}%`
            );
            ...
            layer.on("click", function (e) {
              ...
              let neigh_average = Math.round(values.reduce((sum, v) => sum + v, 0) / values.length, 2);
              ...
              let plot_data2 = [
                {
                  ...
                  y: [
                    feature.properties[filters.age_column].toFixed(2),
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <UnemploymentRateFilers filters={filters} setFilters={setFilters} />
          </div>
...
export default UnemploymentRateMap;
