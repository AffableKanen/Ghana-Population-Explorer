...
import ChildEconOccupationFilters from "../filters/filters_child_econ_occupation_map";
...
function  ChildEconOccupationMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/child_econ_occupation", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <ChildEconOccupationFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default ChildEconOccupationMap;
