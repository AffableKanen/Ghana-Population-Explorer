...
import ChildEconIndustryFilters from "../filters/filters_child_econ_industry_map";
...
function  ChildEconIndustryMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/child_econ_industry", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <ChildEconIndustryFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default ChildEconIndustryMap;
