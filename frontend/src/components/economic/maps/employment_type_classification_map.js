...
import EmploymentClassificationFilters from "../filters/filters_employment_type_classification_map";
...
function  EmploymentTypeClassificationMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/employment_type_classification", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <EmploymentClassificationFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default EmploymentTypeClassificationMap;
