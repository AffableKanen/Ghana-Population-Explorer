...
import EconActiveStatusFilters from "../filters/filters_econ_active_status_map";
...
function  EconActiveStatusMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/econ_active_status", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <EconActiveStatusFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default EconActiveStatusMap;
