...
import EconActiveIndustryFilters from "../filters/filters_econ_active_industry_map";
...
function  EconActiveIndustrysMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/econ_active_industry", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <EconActiveIndustryFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default EconActiveIndustrysMap;
