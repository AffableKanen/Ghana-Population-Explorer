...
import SectorEmploymentFilters from "../filters/filters_sector_employment_map";
...
function  SectorEmploymentMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/sector_employment", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <SectorEmploymentFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default SectorEmploymentMap;
