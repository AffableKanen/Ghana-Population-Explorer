...
import ChildEconStatusFilters from "../filters/filters_child_econ_status_map";
...
function  ChildEconStatusMap() {
  ...
  const [filters, setFilters] = useState({
    ...
    education: "Total",
    active_status: "Economically Active"
  });
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/child_econ_status", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <ChildEconStatusFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default ChildEconStatusMap;
