...
export default function EducationalAttainmentFilters({ filters, setFilters }) {
  return (
    <div className="filters">
      ...
      <div style={{ border: "2px solid #800020", padding: "8px", marginBottom: "6px", maxHeight: "250px", overflowY: "auto", backgroundColor: "#b33655ff" }}>
        <label className="fw-bold text-decoration-underline" style={{ color: "white" }}>HIGHEST EDUCATION ATTAINED</label>
        {['Nursery', 'Kindergarten', 'Primary', 'JSS/JHS', 'Middle','SSS/SHS', 'Secondary', 'Voc/technical/commercial','Post middle/secondary Certificate',
