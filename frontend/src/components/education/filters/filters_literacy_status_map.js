...
export default function LiteracyStatusFilters({ filters, setFilters }) {
  return (
    ...
    {/* Status */}
      <div style={{ border: "2px solid #c42f54ff", padding: "8px", marginBottom: "6px", maxHeight: "120px", overflowY: "auto", backgroundColor: "#b33655ff"}}>
        <label className="fw-bold text-decoration-underline" style={{ color: "white" }}>LITERACY STATUS</label>
        {['Not literate', 'Literate'].map((opt) => (
          <div className="form-check" key={opt}>
            <input
              className="form-check-input"
              type="radio"
