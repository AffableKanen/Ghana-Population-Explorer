...
export default function CurrentAttendanceFilters({ filters, setFilters }) {
  return (
    <div className="filters">
      ...
      <div style={{ border: "2px solid #800020", padding: "8px", marginBottom: "6px", maxHeight: "110px", overflowY: "auto", backgroundColor: "#b33655ff" }}>
        ...
        {[
          ...
          { value: "6-14 years", label: "6-14 years" },
          { value: "15-17 years", label: "15-17 years" },
          { value: "18-19 years", label: "18-19 years" },
          { value: "20-24 years", label: "20-24 years" },
          { value: "25-29 years", label: "25-29 years" },
          { value: "30 years & older", label: "30 years & older" }
      ...
      {/* Education */}
      <div style={{ border: "2px solid #800020", padding: "8px", marginBottom: "6px", maxHeight: "270px", overflowY: "auto", backgroundColor: "#b33655ff" }}>
        <label className="fw-bold text-decoration-underline" style={{ color: "white" }}>EDUCATION</label>
        {['Total', 'Nursery', 'Kindergarten', 'Primary', 'JSS/JHS','SSS/SHS', 'Secondary', 'Voc/technical/commercial','Post middle/secondary Certificate',
           'Post middle/secondary Diploma', 'Tertiary/HND',"Tertiary - Bachelor's Degree",'Tertiary - Post graduate Certificate/Diploma',
           "Tertiary - Master's Degree", 'Tertiary - PhD', 'Other (specify)'].map((opt) => (
          <div className="form-check" key={opt}>
            <input
              className="form-check-input"
              type="radio"
