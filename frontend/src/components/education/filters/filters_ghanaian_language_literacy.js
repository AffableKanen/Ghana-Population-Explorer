...
export default function GhanaianLanguageLiteracyFilters({ filters, setFilters }) {
  return (
    ...
    {/* languages */}
      <div style={{ border: "2px solid #c42f54ff", padding: "8px", marginBottom: "6px", maxHeight: "120px", overflowY: "auto", backgroundColor: "#b33655ff"}}>
        ...
        {['Akwapim_Twi', 'Asante_Twi', 'Fante', 'Nzema', 'Ga', 'Dangme','Ewe', 'Dagbani', 'Gonja', 'Dagaari', 'Kasem', 'Gruni'].map((opt) => (
          <div className="form-check" key={opt}>
            <input
              className="form-check-input"
              type="radio"
