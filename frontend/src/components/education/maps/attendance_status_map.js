...
import AttendanceStatusFilters from "../filters/filters_attendance_status_map";
...
function  AttendanceStatusMap() {
  ...
  const [filters, setFilters] = useState({
    ...
    attendance_status: "Attended in the past",
  });
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/attendance_status", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <AttendanceStatusFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default AttendanceStatusMap;
