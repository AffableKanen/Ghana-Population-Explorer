...
import ForeignLanguageLiteracyFilters from "../filters/filters_foreign_language_literacy_map";
...
function  ForeignLanguageLiteracyMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/foreign_language_literacy", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <ForeignLanguageLiteracyFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default ForeignLanguageLiteracyMap;
