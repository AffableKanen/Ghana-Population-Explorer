...
import EducationalAttainmentFilters from "../filters/filters_educational_attainment_map";
...
function  EducationalAttainmentMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/educational_attainment", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <EducationalAttainmentFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default EducationalAttainmentMap;
