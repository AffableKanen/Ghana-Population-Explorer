...
import PastAttendanceFilters from "../filters/filters_past_attendance_map";
...
function  PastAttendanceMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/past_attendance", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <PastAttendanceFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default PastAttendanceMap;
