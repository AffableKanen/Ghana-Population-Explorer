...
import LiteracyLanguageCountFilters from "../filters/filters_literacy_language_count_map";
...
function  LiteracyLanguageCountMap() {
  ...
  const [filters, setFilters] = useState({
    ...
    education: "Total",
    language_count: "Literate in one language",
  });
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/literacy_language_count", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <LiteracyLanguageCountFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default LiteracyLanguageCountMap;
