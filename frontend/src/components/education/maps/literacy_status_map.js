...
import LiteracyStatusFilters from "../filters/filters_literacy_status_map";
...
function  LiteracyStatusMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/literacy_status", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <LiteracyStatusFilters filters={filters} setFilters={setFilters} />
          </div>
...
export default LiteracyStatusMap;
