...
import SelfcareFilters from '../filters/filters_selfcare_map';
...
function  SelfcareMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/selfcare", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <SelfcareFilters filters={filters} setFilters={setFilters} />
          </div>
