...
import RememberingFilters from '../filters/filters_remembering_map';
...
function  RememberingMap() {
  ...
  const [filters, setFilters] = useState({
    ...
    education: "Total",
    status: "Cannot remember or concentrate at all"
  });
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/remembering", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <RememberingFilters filters={filters} setFilters={setFilters} />
          </div>
