...
import SeeingFilters from '../filters/filters_seeing_map';
...
function  SeeingMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/seeing", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <SeeingFilters filters={filters} setFilters={setFilters} />
          </div>
