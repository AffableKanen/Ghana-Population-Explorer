...
import SpeechFilters from "../filters/filters_speech_map";
...
function  SpeechMap() {
  ...
  const [filters, setFilters] = useState({
    ...
    education: "Total",
    status: "Cannot communicate at all"
  });
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/speech", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <SpeechFilters filters={filters} setFilters={setFilters} />
          </div>
