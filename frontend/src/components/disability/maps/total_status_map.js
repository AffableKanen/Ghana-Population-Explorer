...
import Filters from '../filters/filters_total_status_map';
...
function  TotalStatusMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/total_status", {
      method: "POST",
