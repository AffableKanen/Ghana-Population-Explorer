...
import HearingFilters from "../filters/filters_hearing_map";
...
function  HearingMap() {
  ...
  const updateMap = async (newFilters) => {
    const res = await fetch("http://127.0.0.1:8000/hearing", {
      method: "POST",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <HearingFilters filters={filters} setFilters={setFilters} />
          </div>
